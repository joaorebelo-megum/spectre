...
struct BinaryWithGravitationalWavesVariables
 ...
 private:
  ...
  DataType integrate_term(DataType t, size_t i, size_t j, int left_right,
                          double t0) const;
  tnsr::i<DataType, 3> get_t_deriv_one_over_distance_left(DataType t) const;
  tnsr::i<DataType, 3> get_t_deriv_one_over_distance_right(DataType t) const;
  tnsr::ijk<DataType, 3> get_t_deriv_3_distance_left(DataType t) const;
  tnsr::ijk<DataType, 3> get_t_deriv_3_distance_right(DataType t) const;
  tnsr::ii<DataType, 3> get_t_pn_conjugate_momentum3(DataType t) const;
  tnsr::ii<DataType, 3> get_t_pn_extrinsic_curvature(DataType t) const;
  Scalar<DataType> get_t_trace_extrinsic_curvature(DataType t) const;
  ...
  // tnsr::ab<DataType, 3> get_t_spacetime_metric(DataType t) const;
};
