  ...
  }
  {
    ...
    pypp::check_with_random_values<1>(
        ...
        {"distance_left", "distance_right", "deriv_one_over_distance_left",
         ...
         "root_finder_bracket_time_upper", "shift_background",
         "conformal_factor_minus_one", "energy_density", "stress_trace",
         "momentum_density"},
...
SPECTRE_TEST_CASE(
  ...
  auto start = std::chrono::high_resolution_clock::now();  // >>>> TEST !!!!!!
